      ...
      <Container maxWidth="lg">
        <Grid container>
          ...
          <Grid item xs={6} style={{ textAlign: 'right' }}>
            <a
              href="https://twitter.com/ectofinance"
            ...
            <a
              href="https://github.com/ectofinance/ectofinance-frontend"
              rel="noopener noreferrer"
              target="_blank"
              className={classes.link}
            >
            ...
            <a href="https://t.me/ectofinance" rel="noopener noreferrer" target="_blank" className={classes.link}>
            ...
            <a href="http://discord.ecto.finance/" rel="noopener noreferrer" target="_blank" className={classes.link}>

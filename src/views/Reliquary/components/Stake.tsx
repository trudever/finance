...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(ectoFinance.ESHARE, ectoFinance.contracts.Masonry.address);

  const tokenBalance = useTokenBalance(ectoFinance.ESHARE);
  const stakedBalance = useStakedBalanceOnMasonry();
  const { from, to } = useUnstakeTimerMasonry();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('ESHARE', ectoFinance.ESHARE);

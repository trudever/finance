...
const configurations: { [env: string]: Configuration } = {
  ...
  production: {
    ...
    externalTokens: {
      ...
      MIM: ['0x09e145a1d53c0045f41aeef25d8ff982ae74dd56', 0],
      WETH: ['0x9ba3e4f84a34df4e08c112e1a0ff148b81655615', 9],
      'USDT-FTM-LP': ['0x2b4C76d0dc16BE1C31D4C1DC53bF9B45987Fc75c', 18],
      'ECTO-FTM-LP': ['0x2A651563C9d3Af67aE0388a5c8F89b867038089e', 18],
      'ESHARE-FTM-LP': ['0x4733bc45eF91cF7CcEcaeeDb794727075fB209F2', 18],
    },
    baseLaunchDate: new Date('2021-06-02 13:00:00Z'),
    bondLaunchesAt: new Date('2020-12-03T15:00:00Z'),
    masonryLaunchesAt: new Date('2020-12-11T00:00:00Z'),
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  EctoBooRewardPool: {
    name: 'Earn ECTO by BOO',
    poolId: 1,
    sectionInUI: 0,
    contract: 'EctoBooGenesisRewardPool',
  ...
  EctoShibaRewardPool: {
    name: 'Earn ECTO by WETH',
    poolId: 2,
    sectionInUI: 0,
    contract: 'EctoShibaGenesisRewardPool',
  ...
  EctoZooRewardPool: {
    name: 'Earn ECTO by MIM',
    poolId: 3,
    sectionInUI: 0,
    contract: 'EctoZooGenesisRewardPool',
  ...
  EctoFtmLPEctoRewardPoolOld: {
    name: 'Earn ECTO by ECTO-FTM LP',
    poolId: 0,
    sectionInUI: 1,
    contract: 'EctoFtmLpEctoRewardPoolOld',
    depositTokenName: 'ECTO-FTM-LP',
    earnTokenName: 'ECTO',
    finished: true,
    sort: 9,
  ...
  EctoFtmLPEShareRewardPool: {
    name: 'Earn ESHARE by ECTO-FTM LP',
    poolId: 0,
    sectionInUI: 2,
  ...
  TshareFtmLPEShareRewardPool: {
    name: 'Earn ESHARE by ESHARE-FTM LP',
    poolId: 1,
    sectionInUI: 2,
    contract: 'TshareFtmLPEShareRewardPool',
